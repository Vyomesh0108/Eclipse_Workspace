...
<sql:setDataSoucre driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/stddb" user="root" password="" var="con" />

<sql:query dataSource="${con}" var="result"> select * from mytab </sql:query>

<c:forEach var="row" items="${con}" items="${result.rows }">
